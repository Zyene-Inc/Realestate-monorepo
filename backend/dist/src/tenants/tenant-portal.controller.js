...
let TenantPortalController = class TenantPortalController {
    ...
    async getMaintenance(req) {
        const userId = req.user.sub;
        return this.tenantsService.getMaintenanceRequests(userId);
    }
    async createMaintenance(req, data) {
        const userId = req.user.sub;
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], TenantPortalController.prototype, "getMaintenance", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], TenantPortalController.prototype, "createMaintenance", null);
__decorate([
