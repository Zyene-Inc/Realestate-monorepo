  ...
  const [properties] = useState([
    {
      ...
      status: "Active",
      description:
        "Historic six-plex redevelopment. Quality community housing.",
    ...
    <div className="space-y-8 sm:space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2 font-medium">
            Manage your real estate portfolio and community projects.
          </p>
        </div>
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[600px] rounded-[2rem] border-border bg-card p-5 sm:p-8">
            ...
            <div className="grid gap-6 py-2">
              <div className="grid gap-5 sm:grid-cols-2 sm:gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    id="name"
                    placeholder="e.g. Brookside Court"
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="address"
                  placeholder="123 Street St, Kansas City, MO"
                  className="h-12 rounded-xl bg-secondary/50 border-transparent focus:border-primary transition-[background-color,color,border-color,box-shadow,transform,opacity] font-medium"
                />
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  id="description"
                  placeholder="Describe the property, history, and importance"
                  className="min-h-[100px] rounded-xl bg-secondary/50 border-transparent focus:border-primary transition-[background-color,color,border-color,box-shadow,transform,opacity] font-medium p-4"
                />
              </div>
              <div className="space-y-2">
                ...
                <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-border bg-secondary/30 p-10 text-muted-foreground transition-colors hover:border-primary hover:text-primary">
                  <input
                    type="file"
                    multiple
                  ...
                  <p className="text-[10px] uppercase tracking-widest mt-2 font-medium opacity-70">
            ...
            <DialogFooter className="mt-8">
              <Button
                type="submit"
                className="w-full h-14 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl font-bold text-xs uppercase tracking-widest font-heading transition-[background-color,color,border-color,box-shadow,transform,opacity] shadow-lg shadow-primary/20"
              >
                Save Property
              </Button>
            </DialogFooter>
      ...
      <div className="flex items-center gap-4">
        <div className="relative flex-1 max-w-md">
          ...
          <Input
            className="pl-12 h-12 rounded-2xl border-border bg-card shadow-sm font-medium"
        ...
        <Table>
          <TableHeader className="bg-secondary/50">
            <TableRow className="border-border hover:bg-transparent">
              <TableHead className="w-[350px] font-heading font-bold text-[10px] uppercase tracking-widest text-muted-foreground py-5">
                Property
              </TableHead>
                ...
                <TableCell className="py-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[11px] text-muted-foreground truncate max-w-[200px] font-medium">
                        {property.description}
                      </span>
                    </div>
                  </div>
                </TableCell>
                <TableCell className="text-sm text-foreground font-medium py-4">
                  {property.address}
                </TableCell>
                <TableCell className="text-sm font-bold text-foreground py-4">
                  {property.type}
                </TableCell>
                <TableCell className="font-bold font-heading tabular-nums py-4">
                  {property.units}
                </TableCell>
                <TableCell className="py-4">
                ...
                <TableCell className="text-right py-4">
                  <div className="flex justify-end gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="rounded-lg border-border hover:bg-secondary text-[10px] font-bold uppercase tracking-widest font-heading transition-[background-color,color,border-color,box-shadow,transform,opacity]"
                    >
                      View
                    </Button>
                    <Button
