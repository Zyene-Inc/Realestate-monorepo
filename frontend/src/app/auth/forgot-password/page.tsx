...
export default function ForgotPassword() {
  ...
  return (
    <AuthShell
      ...
      description={
        submitted
          ? "If this address matches an account, a secure recovery link is on its way."
          : "Enter the email connected to your portal account. Recovery links expire for your protection."
      }
    >
      {submitted ? (
        <div
        ...
        >
          ...
          <p className="mt-5 text-sm leading-6 text-muted-foreground">
            You can close this page after checking{" "}
            <strong className="font-semibold text-foreground">{email}</strong>.
            Also check the spam folder if the message takes a moment.
          </p>
          <a
        ...
        <form onSubmit={submit} className="grid gap-5">
          ...
          <p className="text-xs leading-5 text-muted-foreground">
            For privacy, the response is the same whether or not an account
