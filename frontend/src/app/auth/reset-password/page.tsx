...
export default function ResetPassword() {
  ...
  return (
    <AuthShell
      ...
      description={
        success
          ? "Your account is ready for a secure sign in."
          : "Use at least 12 characters with uppercase, lowercase, a number, and a symbol. Known breached passwords are blocked."
      }
    >
      {success ? (
        <div
