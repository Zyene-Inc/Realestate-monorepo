    ...
    <div className="space-y-8">
      ...
      <Card className="rounded-2xl">
        ...
        <CardContent className="space-y-5">
          <label className="inline-flex min-h-11 cursor-pointer items-center rounded-full border border-border bg-card px-5 text-sm font-semibold text-foreground transition-colors hover:border-primary/35 hover:bg-secondary has-[:disabled]:opacity-50">
            {uploading ? (
              <Loader2 className="mr-2 h-4 w-4 animate-spin" />
            ) : (
