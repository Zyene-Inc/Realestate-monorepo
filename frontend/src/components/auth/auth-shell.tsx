...
export function AuthShell({
  ...
  return (
    <main
      id="main-content"
      className="grid min-h-[100dvh] bg-background lg:grid-cols-[minmax(0,1.08fr)_minmax(28rem,.92fr)]"
    >
      <aside className="hidden min-h-[100dvh] overflow-hidden bg-brand text-white lg:flex lg:flex-col">
        ...
        <div className="border-t border-white/12 p-10 xl:p-14">
          <p className="max-w-xl text-3xl font-semibold leading-tight tracking-[-0.035em]">
            A clear path home, and a capable team behind every detail.
          </p>
          <p className="mt-4 max-w-md text-sm leading-6 text-white/72">
            Secure access for residents, approved agent companies, and Coach
            Johnson Realty staff.
          </p>
        </div>
      </aside>
      <section className="flex min-h-[100dvh] flex-col px-5 py-5 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex items-center justify-between">
          <a
            href={PORTAL_ORIGINS.public}
            className="inline-flex min-h-11 items-center gap-2 rounded-full px-2 text-sm font-semibold text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring/25"
          >
